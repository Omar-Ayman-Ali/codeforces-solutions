# [645756O] Peter's Birthday

- **Problem Link:** [https://codeforces.com/group/tTJnpKpFzH/contest/645756/problem/O](https://codeforces.com/group/tTJnpKpFzH/contest/645756/problem/O)
- **Submission ID:** [https://codeforces.com/group/tTJnpKpFzH/contest/645756/submission/355918625](https://codeforces.com/group/tTJnpKpFzH/contest/645756/submission/355918625)
- **Rating:** Unrated
- **Tags:** untagged
- **Language:** C++17 (GCC 7-32)
- **Time Consumed:** 593 ms
...
Peter got an array of integers $a[1 \dots n]$ as a gift. Now he wants to perform a certain number of operations (possibly zero) so that all elements of the array become the same (that is, to become $a_1=a_2=\dots=a_n$).
